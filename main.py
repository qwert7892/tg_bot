...
a_lot_symbols = ['ты зачем так много настрочил',
                 'слишком много инфы',
                 'зачем так много',
                 'перебор, напиши поменьше'
                 ]

underage = ['малолетки тут не сидят',
            'подрасти сначала',
            'ты слишком взрослый',
            'куда лезем, малыш']

unright_signs = ['такого знака не существует',
                 'неверный знак зодиака',
                 'введите правильный знак зодиака',
                 'спроси у мамы знак зодиака']

look = ['ппц ты соска',
        'ничего, внешность не главное',
        'согласен, главное душа',
        'мама наверно говорила что ты ничего']
